...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        grad_out_layer_2 = pred_y * (1 - pred_y) * grad_pred_y
        grad_layer_2 = output_layer_1_act.T @ grad_out_layer_2
        grad_out_layer_1_act = grad_out_layer_2 @ MLP_layer_2.T
        grad_out_layer_1 = output_layer_1_act * (
            1 - output_layer_1_act) * grad_out_layer_1_act
        grad_layer_1 = input_vector.T @ grad_out_layer_1
